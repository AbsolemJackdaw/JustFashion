...
public class FashionCapability {
	...
	public static class StorageHelper implements Capability.IStorage<FashionData>{
		...
		@Override
		public NBTBase writeNBT(Capability<FashionData> capability, FashionData instance, EnumFacing side)		{
			//return instance.getTheRpgInventory().serializeNBT();
			return instance.writeData();
		}

		@Override
		public void readNBT(Capability<FashionData> capability, FashionData instance, EnumFacing side, NBTBase nbt){
