...
public class ModelFashionBody extends ModelFashion {
    ...
    public ModelFashionBody(float modelSize, boolean smallArms) {
        ...
        this.bipedBodyWear = new RendererModel(this, 0, 16);
        this.bipedBodyWear.addBox(-4.0F, 0.0F, -2.0F, 8, 12, 4, modelSize + 0.25F);
        this.bipedBodyWear.setRotationPoint(0.0F, 0.0F, 0.0F);

        if (smallArms) {
            this.bipedLeftArm = new RendererModel(this, 24, 0);
            this.bipedLeftArm.addBox(-1.0F, -2.0F, -2.0F, 3, 12, 4, modelSize);
            this.bipedLeftArm.setRotationPoint(5.0F, 2.5F, 0.0F);

            this.bipedRightArm = new RendererModel(this, 40, 0);
            this.bipedRightArm.addBox(-2.0F, -2.0F, -2.0F, 3, 12, 4, modelSize);
            this.bipedRightArm.setRotationPoint(-5.0F, 2.5F, 0.0F);

            this.bipedLeftArmwear = new RendererModel(this, 24, 16);
            this.bipedLeftArmwear.addBox(-1.0F, -2.0F, -2.0F, 3, 12, 4, modelSize + 0.25F);
            this.bipedLeftArmwear.setRotationPoint(5.0F, 2.5F, 0.0F);

            this.bipedRightArmwear = new RendererModel(this, 40, 16);
            ...
            this.bipedLeftArm = new RendererModel(this, 40, 0);
            this.bipedLeftArm.mirror = true;
            this.bipedLeftArm.addBox(-1.0F, -2.0F, -2.0F, 4, 12, 4, modelSize);
            this.bipedLeftArm.setRotationPoint(5.0F, 2.0F + offset, 0.0F);

            this.bipedLeftArmwear = new RendererModel(this, 40, 16);
            this.bipedLeftArmwear.mirror = true;
            this.bipedLeftArmwear.addBox(-1.0F, -2.0F, -2.0F, 4, 12, 4, modelSize + 0.25F);
            this.bipedLeftArmwear.setRotationPoint(5.0F, 2.0F, 0.0F);

            this.bipedRightArmwear = new RendererModel(this, 24, 16);
